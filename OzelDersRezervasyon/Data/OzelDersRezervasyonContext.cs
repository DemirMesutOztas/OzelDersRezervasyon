...
namespace OzelDersRezervasyon.Data
{
    public class OzelDersRezervasyonContext : DbContext
    {
        ...
        public OzelDersRezervasyonContext() : base("name=OzelDersRezervasyonContext")
        {
        }
